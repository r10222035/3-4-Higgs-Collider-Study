#!/usr/bin/env python
# coding: utf-8
# python from_root_to_h5-DNN.py <root_file_path> <output_file_path>

# extract DNN information from .root save in .h5 file
# .h5 file: SPANet 1 format
...
def main(file_path, output_path, nbj_min=2, nevent_max=100000):
    ...
    # Contain the information for DNN training
