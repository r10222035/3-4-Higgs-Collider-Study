...
\label{sec:di_higgs_signal_background_analysis}
	...
	\label{sub:atlas}
		...
		The ``$\Delta R + \text{min-}D_{HH}$'' pairing is replaced by SPANet pairing. Other cuts remained unchanged. The cutflow tables for signal and background are in Table \ref{tab:signal_selection_efficiency_1000GeV_MV2c10_SPANet}, \ref{tab:signal_selection_efficiency_background_MV2c10_SPANet}.
			\begin{table}[htpb]
				\centering
				...
				\begin{tabular}{l|cc|cc|cc}
					...
					Top veto      & 0.0375      & 0.9612      & 0.0426    & 0.9555                          & 0.0446        & 0.9534   
				\end{tabular}
			\end{table}
			\begin{table}[htpb]
				\centering
				\caption{The selection passing rate and efficiency at each stage for ``$\Delta R + \text{min-}D_{HH}$'' and SPA-NET pairing. }
				\label{tab:signal_selection_efficiency_background_MV2c10_SPANet}
				\begin{tabular}{l|cc|cc}
								  & \multicolumn{4}{c}{pp4b}                                                         \\
								  & \multicolumn{2}{c|}{$\Delta R + \text{min-}D_{HH}$}& \multicolumn{2}{c}{SPA-NET} \\
					Cut           & pass rate               & efficiency               & pass rate    & efficiency   \\ \hline
					Four tag      & 0.0096                  & 0.0096                   & 0.0096       & 0.0096       \\
					Delta R       & 0.0050                  & 0.5234                   &  N.A.        & N.A.         \\
					Higgs PT      & 0.0043                  & 0.8462                   & 0.0065       & 0.6714       \\
					Higgs Eta     & 0.0030                  & 0.7127                   & 0.0048       & 0.7380       \\
					Signal region & 0.0005                  & 0.1551                   & 0.0001       & 0.0174       \\
					Top veto      & 0.0003                  & 0.5975                   & 0.0001       & 0.8675      
				\end{tabular}
				\begin{tabular}{l|cc|cc}
								  & \multicolumn{4}{c}{pptt}                                                         \\
								  & \multicolumn{2}{c}{$\Delta R + \text{min-}D_{HH}$} & \multicolumn{2}{c}{SPA-NET} \\
					Cut           & pass rate               & efficiency               & pass rate    & efficiency   \\ \hline
					Four tag      & 0.000747                & 0.000747                 & 0.000747     & 0.000747     \\
					Delta R       & 0.000418                & 0.559572                 & N.A.         & N.A.         \\
					Higgs PT      & 0.000370                & 0.885167                 & 0.000548     & 0.733601     \\
					Higgs Eta     & 0.000310                & 0.837838                 & 0.000444     & 0.810219     \\
					Signal region & 0.000067                & 0.216129                 & 0.000030     & 0.067568     \\
					Top veto      & 0.000021                & 0.313433                 & 0.000010     & 0.333333    
				\end{tabular}
			\end{table}

			To separate the signal and background, apply the same selection steps to both samples. The background process are pp->4b and pp->tt->4j2b. Add up the cross sections of two background processes. The ``$\Delta R + \text{min-}D_{HH}$'' result is in Table \ref{tab:diHiggs_signal_background_analysis_ATLAS_minDHH}. The SPANet result is in Table \ref{tab:diHiggs_signal_background_analysis_ATLAS_SPANet}.

			After the ``Signal region cut'', the SPANet pairing method has an improvement on $S/\sqrt{B}$.
			\begin{table}[htpb]
				\centering
				...
				\begin{tabular}{l|cc|c|c|c|c}
					...
					Four tag     & 0.081            & 6.26e+03             & 1.29e-05 & 0.0121                              & 0.0177                              & 0.0561                               \\
					Delta R      & 0.070            & 3.28e+03             & 2.13e-05 & 0.0144                              & 0.0212                              & 0.0669                               \\
					Higgs PT     & 0.058            & 2.78e+03             & 2.08e-05 & 0.0129                              & 0.0190                              & 0.0600                               \\
					Higgs Eta    & 0.053            & 2.00e+03             & 2.67e-05 & 0.0140                              & 0.0206                              & 0.0652                               \\
					Signal region& 0.029            & 3.14e+02             & 9.13e-05 & 0.0191                              & 0.0280                              & 0.0886                               \\
					Top veto     & 0.027            & 1.83e+02             & 0.00015  & 0.0239                              & 0.0351                              & 0.1110                              
				\end{tabular}	
			\end{table}
			...
			\begin{table}[htpb]
				...
				\begin{tabular}{l|cc|c|c|c|c}
					...
					No cut       & 0.644            & 8.92e+05             & 7.22e-07 & 0.00804                             & 0.0118                              & 0.0374                               \\
					Four tag     & 0.081            & 6.26e+03             & 1.29e-05 & 0.0121                              & 0.0177                              & 0.0561                               \\
					Higgs PT     & 0.063            & 4.21e+03             & 1.49e-05 & 0.0114                              & 0.0168                              & 0.0530                               \\
					Higgs Eta    & 0.058            & 3.12e+03             & 1.85e-05 & 0.0122                              & 0.0179                              & 0.0567                               \\
					Signal region& 0.030            & 60.1                 & 0.000502 & 0.0459                              & 0.0674                              & 0.2130                               \\
					Top veto     & 0.029            & 47.9                 & 0.000600 & 0.0490                              & 0.0719                              & 0.2270                              
				\end{tabular}
			\end{table}

		% subsubsection use_spanet_for_event_selection (end)
		\subsubsection{Plots}% (fold)
		\label{subs:plots}
			The $\Delta R$ v.s. $m_{\text{4j}}$ plots are in Figure \ref{fig:Higgs_deltaR_m4j}.
			\begin{figure}[htpb]
				\centering
				\includegraphics[width=0.9\textwidth]{Higgs_deltaR_m4j_s.png}
				\includegraphics[width=0.9\textwidth]{Higgs_deltaR_m4j_4b.png}
				\includegraphics[width=0.9\textwidth]{Higgs_deltaR_m4j_tt.png}
				\caption{The $\Delta R_{jj}$ for Higgs candidate.}
				\label{fig:Higgs_deltaR_m4j}
			\end{figure}

			The histograms for Higgs candidate mass are in Figure \ref{fig:Higgs_mass_DHH}, \ref{fig:Higgs_mass_SPANET}.
			\begin{figure}[htpb]
				\centering
				\includegraphics[width=0.9\textwidth]{Higgs_mass_DHH_s.png}
				\includegraphics[width=0.9\textwidth]{Higgs_mass_DHH_4b.png}
				\includegraphics[width=0.9\textwidth]{Higgs_mass_DHH_tt.png}
				\caption{The mass plane and distribution for Higgs candidate. The pairing method is ``$\Delta R + \text{min-}D_{HH}$''.}
				\label{fig:Higgs_mass_DHH}
			\end{figure}

			\begin{figure}[htpb]
				\centering
				\includegraphics[width=0.9\textwidth]{Higgs_mass_SPANET_s.png}
				\includegraphics[width=0.9\textwidth]{Higgs_mass_SPANET_4b.png}
				\includegraphics[width=0.9\textwidth]{Higgs_mass_SPANET_tt.png}
				\caption{The mass plane and distribution for Higgs candidate. The pairing method is SPA-NET.}
				\label{fig:Higgs_mass_SPANET}
			\end{figure}

			\begin{figure}[htpb]
				\centering
				\includegraphics[width=0.6\textwidth]{Higgs_mHH_DHH_s.png}
				\includegraphics[width=0.6\textwidth]{Higgs_mHH_DHH_4b.png}
				\caption{The di-Higgs mass distribution. The pairing method is ``$\Delta R + \text{min-}D_{HH}$''.}
				\label{fig:Higgs_mHH_DHH}
			\end{figure}

			\begin{figure}[htpb]
				\centering
				\includegraphics[width=0.6\textwidth]{Higgs_mHH_SPANet_s.png}
				\includegraphics[width=0.6\textwidth]{Higgs_mHH_SPANet_4b.png}
				\caption{The di-Higgs mass distribution. The pairing method is SPA-NET.}
				\label{fig:Higgs_mHH_SPANET}
			\end{figure}

		% subsubsection plots (end)		
	% subsection atlas (end)	
% section di_higgs_signal_background_analysis (end)			
\section{Tri-Higgs signal background analysis}% (fold)
\label{sec:tri_higgs_signal_background_analysis}
	\subsection{Tri-Higgs selection step}% (fold)
	\label{sub:tri_higgs_selection_step}
		The selection steps:

		\begin{itemize}
			\item Six tag: The event contains at least 6 b-tagged anti-kt small-$R$ ($R = 0.4$) jets with $p_\text{T} > \text{25 GeV}$ and $\abs{\eta} < 2.5$. The six jets with the highest transverse momentum are paired to construct three Higgs boson candidates.
			\item Pick the pairing which minimizes the mass difference of 3 Higgs candidates, i.e., minimize
			\[
				\chi^2 = [M(\text{b}_1\text{b}_2) - M(\text{b}_3 \text{b}_4)]^2 + [M(\text{b}_1\text{b}_2) - M(\text{b}_5 \text{b}_6)]^2 +[M(\text{b}_3\text{b}_4) - M(\text{b}_5 \text{b}_6)]^2
			\] 
			\item Signal region:
			\[
				X_{HHH} = \sqrt{ [M(H_1) - M_\text{H}]^2 + [M(H_2) - M_\text{H}]^2 + [M(H_3) - M_\text{H}]^2} < \text{40 GeV}
			\] 
		\end{itemize}
	% subsection tri_higgs_selection_step (end)
% section tri_higgs_signal_background_analysis (end)	
\section{SPANET for di-Higgs mixing samples}% (fold)
\label{sec:spanet_for_di_higgs_mixing_samples}
	\subsection{Training sample preparation}% (fold)
	\label{sub:training_sample_preparation}
		The di-Higgs process pp->h2, h2->hh, h->bb was generated at $\sqrt{s}= \text{13 TeV}$ using MadGraph. Then pass these events to Pythia8 for showering and hadronization. Then pass to Delphes for detector simulation. 

		The b-tagging part in the Delphes card is set such that the efficiency is the same as the MV2c10 b-tagger at 70\% WP. The b-jet eﬀiciency is set to 0.70. The c-jet missing rate is set to 0.083. The light jet missing rate is set to 0.0026.

		Jets are reconstructed by the anti-$k_t$ algorithm with radius $R=0.4$ and are required to have $p_\text{T}\ge \text{20 GeV}$.

		Generate the samples with different $h_2$ mass. Then mix these samples.

		Preselection cut: required at least 4 b-tagged jet with $p_{\text{T}} > \text{40 GeV}$ in range $\abs{\eta} < 2.5$.

		Define the correct jet assignments by matching them to the simulated truth quarks within an angular distance of $\Delta R = \sqrt{\Delta\eta^2 + \Delta\phi^2}<0.4$.

	% subsection training_sample_preparation (end)

	\subsection{Training results for mixing samples}% (fold)
	\label{sub:training_results_for_mixing_samples}
		\paragraph{Case 1:} Mix $m_H = \text{300 GeV}$, $\text{600 GeV}$, $\text{1000 GeV}$ samples.
		\begin{itemize}
			\item Training sample:
			\begin{itemize}
				\item Total sample size: 20,000 + 20,000 + 20,000 = 60,000
				\item 1h sample size:  3,770 + 3,112 + 2,130 = 8,982
				\item 2h sample size:  15,431 + 16,715 + 17,780 = 49,926
				\item 5\% used on validation
			\end{itemize}
			\item Testing sample: 
				\begin{itemize}
					\item Total sample size: 2,000 + 2,000 + 2,000 = 6,000
					\item 1h sample size: 368 + 309 + 232 = 909
					\item 2h sample size: 1,547 + 1,675 + 1,759 = 4,981
				\end{itemize}
		\end{itemize}

		The training results is presented in Table \ref{tab:SPANet_diHiggs_4btag_MV2c10_pt40_mix}.
		\begin{table}[htpb]
			\centering
			\caption{SPA-NET training results on the mixing di-Higgs samples.}
			\label{tab:SPANet_diHiggs_4btag_MV2c10_pt40_mix}
			\begin{tabular}{c|ccc|c}
					 & \multicolumn{4}{c}{Efficiency}        \\
				Case & 300 GeV  & 600 GeV  & 1000 GeV & Total \\ \hline
				1    & 0.765    & 0.907    & 0.956    & 0.880
			\end{tabular}
		\end{table}
		
	% subsection training_results_for_mixing_samples (end)	
	\subsection{Performance comparison}% (fold)
	\label{sub:performance_comparison}
		Calculate the pairing efficiency for $D_{HH}$ method and the SPA-NET trained in Section \ref{sub:training_results_for_mixing_samples}.

		These pairing methods are tested on the 2h sample in which the 4 quarks from Higgs can be matched to separate 4 jets.

		The pairing efficiency is defined as 
		\[
			\text{efficiency} = \frac{\text{Correct pairing sample size}}{\text{Total 2h sample size}}
		\] 

		The results is in Figure \ref{fig:pairing_efficiency}.

		\begin{figure}[htpb]
			\centering
			\includegraphics[width=0.8\textwidth]{pairing_efficiency.png}
			\caption{Performance of SPA-NET method compared to the $D_{HH} + \Delta R$ method.}
			\label{fig:pairing_efficiency}
		\end{figure}
	% subsection performance_comparison (end)	

% section spanet_for_di_higgs_mixing_samples (end)		
\section{Decay width}% (fold)
\label{sec:decay_width}
	Check the heavy Higgs decay width in 2HDM. Check the MadGraph banner. For $m_H = \text{1000 GeV}$, decay width is $\text{35.5 GeV}$. For $m_H = \text{300 GeV}$, decay width is $\text{71.8 GeV}$. For $m_H = \text{600 GeV}$, decay width is $\text{56.9 GeV}$.

	The above decay widths are copied from the 2HDMC output.
% section decay_width (end)		
...
\label{sec:generate_di_higgs_samples_in_sm}
	...
	\label{sub:variation_with_kappa_lambda}
		...
		\begin{enumerate}
			\item Go to MadGraph model file directory. Copy \verb+loop_sm+ to \verb+my_loop_sm+.
	...
	\label{sub:di_Higgs_sample_generating_results}
		The cross section of various $\kappa_\lambda$ is showed in Table \ref{tab:di-Higgs-SM-kappa-cross-section}.
		\begin{table}[htpb]
			\centering
			\caption{The cross section of various $\kappa_\lambda$. My data is the results from MadGraph. The reference data is from \href{https://link.springer.com/content/pdf/10.1007/JHEP06(2019)066.pdf}{here}. }
			\label{tab:di-Higgs-SM-kappa-cross-section}
			\begin{tabular}{c|cc|c}
								 & \multicolumn{2}{c|}{Cross section (fb)} &       \\
				$\kappa_\lambda$ & Ref.              & My data            & Ratio \\ \hline
				-1               & 116.71            & 74.62              & 1.564 \\
				0                & 62.51             & 41.96              & 1.490 \\
				1                & 27.84             & 20.27              & 1.373 \\
				2                & 12.42             & 9.56               & 1.299 \\
				2.4              & 11.65             & 8.33               & 1.399 \\
				3                & 16.28             & 9.81               & 1.660 \\
				5                & 81.74             & 43.55              & 1.877
			\end{tabular}
		\end{table}

		The $m_{HH}$ distribution with various $\kappa_\lambda$ is presented in Figure \ref{fig:di-Higgs-SM-kappa-mhh-my-data}. In this plot, the data is the parton level data from MadGraph. Compare to the results in Figure \ref{fig:di-Higgs-SM-kappa-mhh-ref}.
		\begin{figure}[htpb]
			\centering
			\includegraphics[width=0.8\textwidth]{di-Higgs-SM-kappa-mhh-my-data.png}
			\caption{The $m_{HH}$ distribution with various $\kappa_\lambda$. The bin height is weighted by the cross section.}
			\label{fig:di-Higgs-SM-kappa-mhh-my-data}
		\end{figure}
		\begin{figure}[htpb]
			\centering
			\includegraphics[width=0.8\textwidth]{di-Higgs-SM-kappa-mhh-ref.png}
			\caption{The dip between the low and high $m_{HH}$ peak due to destructive interference.}
			\label{fig:di-Higgs-SM-kappa-mhh-ref}
		\end{figure}
