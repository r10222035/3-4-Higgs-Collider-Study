...
\label{sec:spanet_for_tri_higgs_events_with_b_tag}
	...
	\label{sub:trainging_result_for_tri_higgs_events}
		...
		\begin{table}[htpb]
			\centering
			\caption{Summary for tri-Higgs training results. 100\% and default are the b-tagging efficiency in Delphes.}
			\label{tab:comparision_triHiggs_results}
			\begin{tabular}{c|cc|c}
				Case & Event Efficiency & Higgs Efficiency & Testing sample \\
				\hline
				$\ge 0$ b 100\%	     &  $0.510 \pm 0.0044$   &  $0.644 \pm 0.0025$  &  12,679	\\
				$\ge 2$ b 100\%	     &  $0.537 \pm 0.0044$   &  $0.665 \pm 0.0024$  &  12,679	\\
				$\ge 4$ b 100\%	     &  $0.539 \pm 0.0044$   &  $0.668 \pm 0.0024$  &  12,679	\\
				$\ge 6$ b 100\%	     &  $0.534 \pm 0.0044$   &  $0.662 \pm 0.0024$  &  12,639	\\
				$\ge 0$ b default	 &  $0.384 \pm 0.0043$   &  $0.564 \pm 0.0025$  &  12,655	\\
				$\ge 2$ b default	 &  $0.383 \pm 0.0044$   &  $0.562 \pm 0.0026$  &  12,321	\\
				$\ge 4$ b default	 &  $0.367 \pm 0.0053$   &  $0.549 \pm 0.0032$  &  8,124	\\
				$\ge 6$ b default	 &  $0.290 \pm 0.0134$   &  $0.417 \pm 0.0084$  &  1,153	\\
				no b-tag			 &  $0.351 \pm 0.0042$   &  $0.545 \pm 0.0026$  &  12,655	\\
				$\ge 6$ b default	 &  $0.389 \pm 0.0045$   &  $0.565 \pm 0.0026$  &  11,908	\\
				$\ge 0$ b default	 &  $0.443 \pm 0.0020$   &  $0.611 \pm 0.0011$  &  62,944	\\
			\end{tabular}
		\end{table}
	...
	\label{sub:test_on_different_dataset}
		For example, use Case 11 samples for training and test on Case 9 samples. The results are presented in Table \ref{tab:SPANet_test_on_different_triHiggs_data}.
		\begin{table}[htpb]
			\centering
			\caption{SPANet test on different samples.}
			\label{tab:SPANet_test_on_different_triHiggs_data}
			\begin{tabular}{cccc}
				Training samples & Testing samples & Event efficiency & Higgs efficiency \\
				\hline 
				0b default      & 0b default     & 0.443        & 0.611    \\
				0b default      & 2b default     & 0.445        & 0.612    \\
				0b default      & 4b default     & 0.450        & 0.616    \\
				0b default      & 6b default     & 0.428        & 0.599    \\
			\end{tabular}
		\end{table}	
