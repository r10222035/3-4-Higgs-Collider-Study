...
\label{sec:generate_di_higgs_samples_in_sm}
	...
	\label{sub:di_Higgs_sample_generating_results}
		...
		The $m_{HH}$ distribution with various $\kappa_\lambda$ is presented in Figure \ref{fig:di-Higgs-SM-kappa-mhh}. In the left plot, the data is the parton level data from MadGraph. The right plot come from ATLAS reference.
		\begin{figure}[htpb]
			\centering
