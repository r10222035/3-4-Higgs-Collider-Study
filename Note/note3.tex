...
\label{sec:resonant_samples_with_various_mass}
	...
	\subsection{Event classification}% (fold)
	\label{sub:event_classification}
		...
		\end{figure}
	% subsection event_classification (end)
	\subsection{SPANet classifier}% (fold)
	...
	% subsection spanet_classifier (end)	
	...
	\subsection{Optimize threshold}% (fold)
	...
	% subsection optimize_threshold (end)
	\subsection{Cross section upper limit}% (fold)
	\label{sub:cross_section_upper_limit}
		...
		\end{figure}
	% subsection cross_section_upper_limit (end)		
	\subsection{SPANet Fine-tuning}% (fold)
	...
	% subsection spanet_fine_tuning (end)
	\subsection{DNN classifier}% (fold)
	\label{sub:dnn_classifier}
		...
		\end{figure}
	% subsection dnn_classifier (end)	
% section resonant_samples_with_various_mass (end)	
\section{DNN input features}% (fold)
\label{sec:dnn_input_features}
	...
	\begin{table}[htpb]
		...
		\end{tabular}
	\end{table}
% section dnn_input_features (end)		
\end{document} 
